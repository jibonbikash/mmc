...
class Uisc_device_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    public function index()
    {
        ...
        $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("report/uisc_device_list",$data,true));
        $ajax['system_page_url']=$this->get_encoded_url('report/uisc_device_list');
