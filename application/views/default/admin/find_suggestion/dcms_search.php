...
<div id="system_content" class="dashboard-wrapper">
    <div class="grid_10" >
        <form action="<?php echo $CI->get_encoded_url('admin/find_suggestion/index/list'); ?>" class="signup" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="frm_user_approval">
            <div class="box round first">
                <h2><?php echo $this->lang->line('FIND_SUGGESTION');?></h2>
                <div class="block ">
                    <table class="signup table" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <td  class="custom labelcell"><label for="name"><?php echo $this->lang->line('START_DATE')?></label></td>
                                <td  class="custom fieldcell">
                                    <div class="input text">
                                        <input name="start_date" id="date" class="range_date" value="" type="text"/>
                                    </div>
                                </td>
                                <td  class="custom labelcell"><label for="name"><?php echo $this->lang->line('END_DATE')?></label></td>
                                <td  class="custom fieldcell">
                                    <div class="input text">
                                        <input name="end_date" id="date" class="range_date" value="" type="text"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
