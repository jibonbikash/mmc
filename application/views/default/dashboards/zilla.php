...
<div id="system_content" class="system_content col-sm-12 text-center" style="margin-top: 5px;">
    ...
    <div class="system_content col-sm-2 text-center" >
        <div class="shadow curved-2">
            ...
            <br/>
            <h4><?php echo sprintf($CI->lang->line('TOTAL_DIGITAL_CENTER'),Dashboard_helper::get_center_count_zilla($user->zilla)); ?></h4>
        </div>
    </div>
    ...
    <div class="system_content col-sm-2 text-center" >
        <div class="shadow curved-2">
            ...
            <br/>
            <h4><?php echo sprintf($CI->lang->line('TOTAL_USERS'),Dashboard_helper::get_uisc_user_count_zilla($user->zilla,$CI->config->item('GENDER_FEMALE'))); ?></h4>
        </div>
    </div>
    ...
    <div class="system_content col-sm-2 text-center" >
        <div class="shadow curved-2">
            ...
            <br/>
            <h4><?php echo sprintf($CI->lang->line('TOTAL_USERS'),Dashboard_helper::get_uisc_user_count_zilla($user->zilla,$CI->config->item('GENDER_MALE'))); ?></h4>
        </div>
    </div>
    ...
    <div class="system_content col-sm-2 text-center" >
        <div class="shadow curved-2">
            ...
            <br/>
            <h4><?php echo sprintf($CI->lang->line('TOTAL_SERVICES'),Dashboard_helper::get_total_services_zilla($user->zilla)); ?></h4>
        </div>
    </div>
    ...
    <div class="system_content col-sm-2 text-center" >
        <div class="shadow curved-2">
            ...
            <br/>
            <h4><?php echo sprintf($CI->lang->line('TOTAL_INVOICES'),Dashboard_helper::get_total_invoices_zilla($user->zilla)); ?></h4>
        </div>
    </div>
    ...
    <div class="system_content col-sm-2 text-center" >
        <div class="shadow curved-2">
            ...
            <br/>
            <h4><?php echo sprintf($CI->lang->line('TOTAL'),Dashboard_helper::get_total_invoice_income_zilla($user->zilla)); ?></h4>
        </div>
    </div>
        ...
        <ul id="dashboard">
            ...
            <li colore="red">
                <div class="contenuto">
                    ...
                    <span class="valore"><?php echo sprintf($CI->lang->line('TI'),Dashboard_helper::get_total_inactive_center_zilla($user->zilla)); ?></span>
                </div>
            </li>
            ...
            <li colore="yellow">
                <div class="contenuto">
                    ...
                    <span class="valore"><?php echo sprintf($CI->lang->line('TI'),Dashboard_helper::get_total_approval_zilla($user->zilla)); ?></span>
                </div>
            </li>
            ...
            <li colore="lime">
                <div class="contenuto">
                    ...
                    <span class="valore"><?php echo sprintf($CI->lang->line('TI'),Dashboard_helper::get_total_notice_zilla()); ?></span>
                </div>
            </li>
            <li colore="orange">
                <div class="contenuto">
                    ...
                    <span class="valore"><?php echo sprintf($CI->lang->line('TI'),Dashboard_helper::get_total_faqs_zilla($user->zilla)); ?></span>
                </div>
            </li>
...
<script>
    $(function () {
        $('#container').highcharts({
            ...
            title: {
                text: '<?php echo $CI->lang->line('REPORT_TITLE_UPAZILLA');?>'
            },
            xAxis: {
                categories: [<?php
             $index=0;
