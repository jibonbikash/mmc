...
(function (a) {
    ...
    a.jqx.jqxWidget = function (b, d, j) {
        ...
        a.extend(a.jqx["_" + g].prototype, {toThemeProperty: function (e, k) {
            if (this.theme == "") {
                return e
            }
            if (k != null && k) {
    ...
    a.extend(a.jqx.mobile, {_touchListener: function (h, f) {
        ...
        try {
            ...
            if (navigator.platform.toLowerCase().indexOf("win") != -1) {
                if (navigator.userAgent.indexOf("Windows Phone") >= 0 || navigator.userAgent.indexOf("WPsystemtop") >= 0 || navigator.userAgent.indexOf("IEMobile") >= 0 || navigator.userAgent.indexOf("ZuneWP7") >= 0) {
                    this.touchDevice = true;
                    return true
                } else {
        ...
        var f = (d.indexOf("windows phone") != -1 || d.indexOf("WPsystemtop") != -1 || d.indexOf("ZuneWP7") != -1 || d.indexOf("msie 9") != -1 || d.indexOf("msie 11") != -1 || d.indexOf("msie 10") != -1) && d.indexOf("touch") != -1;
        if (f) {
            return b.top
        }
        ...
        var c = navigator.userAgent.toLowerCase();
        var b = (c.indexOf("windows phone") != -1 || c.indexOf("WPsystemtop") != -1 || c.indexOf("ZuneWP7") != -1 || c.indexOf("msie 9") != -1 || c.indexOf("msie 11") != -1 || c.indexOf("msie 10") != -1) && c.indexOf("touch") != -1;
        return b
    ...
    a.extend(jQuery.easing, {easeOutBack: function (f, g, e, k, j, h) {
        if (h == undefined) {
            h = 1.70158
        }
